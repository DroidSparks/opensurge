Unless explicitly told otherwise, the files in this folder are licensed under the CC-BY-SA 3.0. The same applies to its subfolders, recursively.
...
--- explosion.png (this is CC-BY 3.0)
...
Alexandre Martins & Brian Zablocky
--- quest_extra.png
--- sir_bugsy.png
--- squarebg.png

Alexandre Martins & Colin Beard & qubodup (opengameart.org)
--- editor.png
